...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `46.6µs` | `46.6µs` |
| [Day 2](./src/bin/02.rs) | `47.8ms` | `30.1ms` |
| [Day 3](./src/bin/03.rs) | `18.5µs` | `21.7µs` |
| [Day 4](./src/bin/04.rs) | `743.1µs` | `17.1ms` |
| [Day 5](./src/bin/05.rs) | `90.9µs` | `23.6µs` |
