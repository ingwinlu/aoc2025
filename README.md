...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `47.2µs` | `50.0µs` |
| [Day 2](./src/bin/02.rs) | `51.6ms` | `31.9ms` |
| [Day 3](./src/bin/03.rs) | `19.8µs` | `22.8µs` |
| [Day 4](./src/bin/04.rs) | `784.5µs` | `18.3ms` |
| [Day 5](./src/bin/05.rs) | `93.2µs` | `24.7µs` |
| [Day 6](./src/bin/06.rs) | `33.7µs` | `56.5µs` |
| [Day 7](./src/bin/07.rs) | `642.0µs` | `942.3µs` |
| [Day 8](./src/bin/08.rs) | `31.2ms` | `30.1ms` |
| [Day 9](./src/bin/09.rs) | `180.5µs` | `151.0ms` |
| [Day 10](./src/bin/10.rs) | `18.0ms` | `5.7ms` |
| [Day 11](./src/bin/11.rs) | `339.4µs` | `419.4µs` |
